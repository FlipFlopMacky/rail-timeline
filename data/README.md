...
本プロジェクトでは東武東上線、秩父鉄道秩父本線、東武スカイツリーライン、東武野田線、JR武蔵野線、西武池袋線、西武秩父線、西武新宿線、西武国分寺線の9路線の駅履歴を扱います。
...
### 東武野田線（アーバンパークライン・大宮～船橋）

`src/data/tobuNodaStationHistory.ts` に大宮～船橋間35駅の履歴を定義しています。

**主な沿革：** 1911年 千葉県営鉄道 野田町～柏 → 1923年 船橋線 船橋～柏 → 1929年 野田町～清水公園、春日部（粕壁）～大宮仮 → 1930年 清水公園～春日部で全通 → 加倉・渋江・北柏・武州川辺・土井停留場など廃止駅は未収録
...
`src/data/seibuShinjukuStationHistory.ts` に全線の駅履歴を定義しています。

**主な沿革：** 1895年 川越鉄道 久米川仮～川越開業（現・東村山以北）→ 1927年 村山線（高田馬場～東村山）開業と川越区間電化 → 1952年 西武新宿延伸・全線一体として新宿線。西鷺宮・東小平・所沢御幸町（旧位置）廃止、川越→本川越・入間川→狭山市・上保谷→東伏見・所沢飛行場前→航空公園など改称を収録

### 西武国分寺線（国分寺～東村山）

`src/data/seibuKokubunjiStationHistory.ts` に全線5駅の履歴を定義しています。

**主な沿革：** 1894年 川越鉄道 国分寺～久米川（仮）開業（国分寺・小川）→ 1895年 東村山開業 → 1927年 村山線開業により国分寺～東村山が支線化（現・国分寺線）。1948年 鷹の台、1955年 恋ヶ窪が開業。羽根沢信号場は対象外
...
**東武野田線（アーバンパークライン）**
- **[Wikipedia 東武野田線](https://ja.wikipedia.org/wiki/%E6%9D%B1%E6%AD%A6%E9%87%8E%E7%94%B0%E7%B7%9A)** - 年表・駅一覧
- **[train.teraren.com 野田線](https://train.teraren.com/lines/21004/stations)** - 各駅の緯度経度
...
**西武新宿線**
- **[Wikipedia 西武新宿線](https://ja.wikipedia.org/wiki/%E8%A5%BF%E6%AD%A6%E6%96%B0%E5%AE%BF%E7%B7%9A)** - 駅一覧・年表・廃止駅
- **[train.teraren.com 西武新宿線](https://train.teraren.com/lines/22007/stations)** - 各駅の緯度経度

**西武国分寺線**
- **[Wikipedia 西武国分寺線](https://ja.wikipedia.org/wiki/%E8%A5%BF%E6%AD%A6%E5%9B%BD%E5%88%86%E5%AF%BA%E7%B7%9A)** - 沿革・駅一覧
- **[train.teraren.com 西武国分寺線](https://train.teraren.com/lines/22010/stations)** - 各駅の緯度経度
...
**西武新宿線**
- 緯度経度は [train.teraren.com 西武新宿線](https://train.teraren.com/lines/22007/stations) を参照（西武新宿は地図基準で経度を補正）
- 廃止駅（西鷺宮・東小平・所沢御幸町旧址）は概略座標。安比奈線・川越競馬場前臨時駅は対象外

**西武国分寺線**
- 緯度経度は [train.teraren.com 西武国分寺線](https://train.teraren.com/lines/22010/stations) を参照
- 旅客駅5駅のみ。羽根沢信号場は対象外

**東武野田線**
- 緯度経度は [train.teraren.com 路線21004](https://train.teraren.com/lines/21004/stations) を参照
- 旅客営業の現役35駅のみ。廃止駅・貨物駅は未収録。春日部は伊勢崎線側データと座標が近接するため、全路線表示ではマーカーが重なる場合あり
